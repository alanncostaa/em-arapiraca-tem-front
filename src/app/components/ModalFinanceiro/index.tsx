...
export function ModalFinanceiro({formTitle, closeModal}: IFormModalProps){
    ...
    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">     
      <div className="relative transform overflow-hidden rounded-lg bg-button text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
        ...
        <form className="flex flex-col gap-4 px-12 mt-4 mb-6">
            ...
            <div className="bg-red text-center text-white rounded-md p-4 justify-center">
              <h1 >A receber</h1>
            </div>
            
            <Input type="number" placeholder="Valor"/>
            <Input type="date" placeholder="Data do Pagamento"/>            
        </form>
        <div className="bg-button px-12 py-3 flex sm:flex-row-reverse w-full mb-16">          
          <button type="button" className="mt-3 w-full justify-center rounded-md bg-color-green text-white px-2 py-4 text-normal font-semibold shadow-sm hover:opacity-80 sm:mt-0" onClick={handleAddCliente}>Receber</button>
        </div>
      </div>
    </div>
  </div>
